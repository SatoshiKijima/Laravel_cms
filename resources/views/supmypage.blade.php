...
<div class="section no-pad-bot" id="index-banner">
    <div class="container">
        <br><br>
        <h1 class="header center orange-text">みらいチケット応援で子供たちの未来の可能性を広げよう</h1>
        <div class="row center">
            <h5 class="header col s12 light">子育て世代を「応援チケット」を通じてサポートするサービスです</h5>
        </div>
        <div class="row center">
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap w-full mb-20">
      <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">感謝のメッセージボード</h1>
        <div class="h-1 w-20 bg-indigo-500 rounded"></div>
      </div>
      <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">提供したみらいチケットを使ったユーザーからお礼のメッセージが届きます。</p>
    </div>
...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">これまでの支援活動履歴</h1>
    </div>
...
<script src="js/materialize01/materialize.js"></script>
<script src="js/materialize01/init.js"></script>
