...
@if (Route::has('login'))
    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
        @auth
            <a href="{{ route('user_home') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">-マイページ-</a>
        @else
            <a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">-ログイン-</a>
             <a href="{{ route('giftcards_index') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">-みらいチケットTOP-</a>
        @endauth
    </div>
@endif